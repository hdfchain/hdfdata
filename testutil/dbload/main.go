...
import (
	...
	tc "github.com/hdfchain/hdfdata/testutil/dbconfig/v2"
	_ "github.com/lib/pq"
)
...
// psql -U postgres -c "DROP DATABASE IF EXISTS hdfdata_mainnet_test"
// psql -U postgres -c "CREATE DATABASE hdfdata_mainnet_test"
