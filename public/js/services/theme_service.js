...
var darkBGCookieName = 'hdfdataDarkBG'
...
function toggleToDarkClasses (body) {
  sunIcon.classList.remove('hdficon-sun-fill')
  sunIcon.classList.add('hdficon-sun-stroke')
  body.classList.add('darkBG')
}
function toggleToLightClasses (body) {
  body.classList.remove('darkBG')
  sunIcon.classList.remove('hdficon-sun-stroke')
  sunIcon.classList.add('hdficon-sun-fill')
}
