...
var defaultConfig = config{
	AppDirectory:     dcrrates.DefaultAppDirectory,
...
func loadConfig() (*config, error) {
	...
	if cfg.CertificatePath == "" {
		cfg.CertificatePath = filepath.Join(cfg.AppDirectory, dcrrates.DefaultCertName)
	} else {
		cfg.CertificatePath = cleanAndExpandPath(cfg.CertificatePath)
	}
	if cfg.KeyPath == "" {
		cfg.KeyPath = filepath.Join(cfg.AppDirectory, dcrrates.DefaultKeyName)
	} else {
