...
import (
	...
	"github.com/hdfchain/hdfdata/explorer/types/v2"
	"github.com/hdfchain/hdfdata/gov/v3/agendas"
	pitypes "github.com/hdfchain/hdfdata/gov/v3/politeia/types"
...
type links struct {
	...
	NetParams       string
	DownloadLink    string
	// Testnet and below are set via hdfdata config.
	Testnet       string
	Mainnet       string
...
var explorerLinks = &links{
	...
	POSExplanation:  "https://docs.clkj.ltdproof-of-stake/overview/",
	APIDocs:         "https://github.com/hdfchain/hdfdata#apis",
	InsightAPIDocs:  "https://github.com/hdfchain/hdfdata/blob/master/api/Insight_API_documentation.md",
	Github:          "https://github.com/hdfchain/hdfdata",
	License:         "https://github.com/hdfchain/hdfdata/blob/master/LICENSE",
	NetParams:       "https://github.com/decred/dcrd/blob/master/chaincfg/params.go",
	DownloadLink:    "https://clkj.ltddownloads/",
}
...
func (exp *explorerUI) Store(blockData *blockdata.BlockData, msgBlock *wire.MsgBlock) error {
	...
	// If BlockData contains non-nil PoolInfo, compute actual percentage of HDF
	// supply staked.
	stakePerc := 45.0
	...
	// https://docs.clkj.ltdadvanced/navigating-politeia-data/#voting-and-comment-data
...
// starting amount of HDF and calculation parameters.  Generate a TEXT table of
// the simulation results that can optionally be used for future expansion of
// hdfdata functionality.
func (exp *explorerUI) simulateASR(StartingDCRBalance float64, IntegerTicketQty bool,
	...
	MaxCoinSupplyAtBlock := func(blocknum float64) float64 {
		// 4th order poly best fit curve to Hdfchain mainnet emissions plot.
	...
	ReturnTable += "\n\nBLOCKNUM        HDF  TICKETS TKT_PRICE TKT_REWRD  ACTION\n"
...
// mempoolTime is the TimeDef that the transaction was received in HDFData, or
