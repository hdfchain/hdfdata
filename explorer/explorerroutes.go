...
// netName returns the name used when referring to a hdfchain network.
...
func (exp *explorerUI) TxPage(w http.ResponseWriter, r *http.Request) {
	...
	// If hdfd has no information about the transaction, pull the transaction
...
func (exp *explorerUI) commonData(r *http.Request) *CommonPageData {
	...
	if err != nil && err != http.ErrNoCookie {
		log.Errorf("Cookie hdfdataDarkBG retrieval error: %v", err)
	}
