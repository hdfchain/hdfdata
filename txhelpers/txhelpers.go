...
// MedianCoin gets the median HDF from a slice of float64s
...
// hash) address. See https://github.com/hdfchain/hdfdata/issues/358 for details.
...
// string. Initially, decoding as a Hdfchain address is attempted. If it fails to
// decode, AddressErrorDecodeFailed is returned with AddressTypeUnknown.
// If the address decoded successfully as a Hdfchain address, it is checked
...
func AddressValidation(address string, params *chaincfg.Params) (dcrutil.Address, AddressType, AddressError) {
	...
	// Determine address type for this valid Hdfchain address. Ignore the error
