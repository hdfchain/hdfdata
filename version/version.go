...
const (
	AppName  string = "hdfdata"
	AppMajor uint   = 5
	AppMinor uint   = 3
	AppPatch uint   = 0
)

// go build -v -ldflags "-X github.com/hdfchain/hdfdata/v5/version.appPreRelease= -X github.com/hdfchain/hdfdata/v5/version.appBuild=`git rev-parse --short HEAD`"
var (
