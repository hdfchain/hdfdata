...
1. Fork the repository on GitHub.  Just click the little Fork button at https://github.com/hdfchain/hdfdata

![image](https://user-images.githubusercontent.com/6109680/47858277-b8910480-ddb9-11e8-9088-a4d1c7b0805d.png)

2. Clone your newly forked hdfdata repository

```sh
git clone git@github.com:my-user-name/hdfdata.git
```
...
```sh
git remote add upstream https://github.com/hdfchain/hdfdata.git
git fetch upstream
...
Since the Hdfchain repo may have changes that you do not have locally, you'll want to pull in any changes and rebase.
...
[Code Contribution Guidelines](https://github.com/decred/dcrd/blob/master/docs/code_contribution_guidelines.md) (hdfd repo)