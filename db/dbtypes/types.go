...
import (
	...
	"github.com/hdfchain/hdfdata/db/dbtypes/v2/internal"
...
const (
	...
	// be effected. https://docs.clkj.ltdglossary/#rule-change-interval-rci.
...
// Tx models a Hdfchain transaction. It is stored in a Block.
type Tx struct {
	//blockDbID  int64
