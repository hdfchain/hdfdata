...
[Experimental support for CockroachDB](https://github.com/hdfchain/hdfdata/issues/1291)
was added for hdfdata 5.0. However, compared to a well-configure PostgreSQL
backend, CoackroachDB performance is suboptimal. See the
[CockroachDB support issue](https://github.com/hdfchain/hdfdata/issues/1291) for
more information.
