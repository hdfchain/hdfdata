...
// MainNetParams contains parameters specific running hdfwallet and
// hdfd on the main network (wire.MainNet).
...
// TestNet3Params contains parameters specific running hdfwallet and
// hdfd on the test network (version 3) (wire.TestNet3).
